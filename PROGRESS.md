...
- **进行中**：M7 BPE+中文（第 1 课 tiktoken 实操 ✅，剩 Qwen3 tokenizer 对比 / BPE 训练原理深挖）
- **下次上课**：**M7 继续**——Qwen3 tokenizer 中文对比 + BPE 训练算法（可选，M11 行业地图再深挖）
...
下次：M7 继续（Qwen3 tokenizer 中文对比 + BPE 训练算法可选）— M7 第 1 课 tiktoken 实操 ✅ 已完成
...
**待办**：Qwen3 tokenizer 对比（阿里模型中文语料多，中文 token 数应比 GPT-4 少）
